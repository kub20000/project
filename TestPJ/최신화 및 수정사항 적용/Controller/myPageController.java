...
public class myPageController {
    ...
    @ResponseBody
    public ResponseEntity<List<VideoHistoryDto>> getCompletedCourses(HttpSession session) {
        // 세션에서 로그인된 사용자 정보 획득
        User loginUser = (User) session.getAttribute("loginUser");
        ...
        // 서비스 호출하여 진도율 100% 강의 목록 (VideoHistoryDto) 가져오기
        List<VideoHistoryDto> completedList = ucService.findCompletedCourses(loginUser.getId());
