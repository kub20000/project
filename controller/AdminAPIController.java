...
import com.bproject.user.entity.UserDto;
...
public class AdminAPIController {
    ...
    public ResponseEntity<?> updateUser(@PathVariable int id, @RequestBody UserDto userDto) {
        ...
        if (!existingUserOpt.isPresent()) return ResponseEntity.notFound().build();

        User dbUser = existingUserOpt.get();
        dbUser.setName(userDto.getName() != null ? userDto.getName() : dbUser.getName());
        dbUser.setEmail(userDto.getEmail() != null ? userDto.getEmail() : dbUser.getEmail());
        dbUser.setRole(userDto.getRole() != null ? userDto.getRole() : dbUser.getRole());
